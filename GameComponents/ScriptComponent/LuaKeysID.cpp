...
void LuaKeysID::Register(lua_State *lua)
{
	...
	luabind::object BasicDrawableTable = luabind::newtable(lua);
		BasicDrawableTable[Keys::BasicDrawable::GRAPHICDRAWABLEID] = Keys::BasicDrawable::GRAPHICDRAWABLEID;
	...
	luabind::object BasicTextureTable = luabind::newtable(lua);
		...
		BasicTextureTable[Keys::BasicTexture::TEXTURESLOT] = Keys::BasicTexture::TEXTURESLOT;
